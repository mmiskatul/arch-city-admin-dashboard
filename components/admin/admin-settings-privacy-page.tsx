      ...
      <article className="rounded-[14px] border border-[#e7e7eb] bg-white p-5">
        ...
        <div className="space-y-5 text-[14px] leading-8 text-[#4b5563]">
          <section>
            ...
            <p className="mt-2">
              Our platform unifies all customer communication channels: WhatsApp, Twilio (SMS), and
              Gmail into a single shared inbox. Teams can collaborate, assign conversations, and
              respond to customers without switching tools, making customer support faster, simpler,
              and more organized.
            </p>
          </section>
