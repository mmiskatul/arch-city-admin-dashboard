...
type SettingsTab = "General" | "Pricing & Fees" | "Terms of Service" | "Privacy & Policy";
        ...
        <div className="grid gap-5 xl:grid-cols-[180px_minmax(0,1fr)]">
          <aside className="pt-2">
            <div className="space-y-1">
              {(["General", "Pricing & Fees", "Terms of Service", "Privacy & Policy"] as const).map(
                (tab) => (
                  <button
                    key={tab}
                    type="button"
                    onClick={() => setActiveTab(tab)}
                    className={`w-full rounded-xl px-3 py-2 text-left text-[15px] font-medium transition ${
                      activeTab === tab
          ...
          <section>
            <div>
              <h1 className="text-[44px] font-bold leading-none text-[#20242b]">General Settings</h1>
              <p className="mt-2 text-[22px] text-[#5b5b99]">Manage your personal account profile</p>
            </div>
